...
- **`com.riquitos.base`**: Reusable components and base classes for all features
...
- **`com.riquitos.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.riquitos` (e.g., `com.riquitos.myfeature`)
